...
proc MomentCurvaturepos {secTag axialLoad maxK {numIncr 100} } {
	...
	# Create recorder
	recorder Node -file DiagphiM/sectiondisp$secTag$axialLoad.pos.out -closeOnWrite -time -node 2 -dof 3 disp
	recorder Node -file DiagphiM/sectionreac$secTag$axialLoad.pos.out -closeOnWrite -time -node 1 -dof 3 reaction
...
proc MomentCurvatureneg {secTag axialLoad maxK {numIncr 100} } {
	...
	# Create recorder
	recorder Node -file DiagphiM/sectiondisp$secTag$axialLoad.neg.out -closeOnWrite -time -node 2 -dof 3 disp
	recorder Node -file DiagphiM/sectionreac$secTag$axialLoad.neg.out -closeOnWrite -time -node 1 -dof 3 reaction
...
if 0 {
	...
	proc MomentCurvatureComppos {secTag axialLoad maxK {numIncr 100} } {
		...
		# Create recorder
		recorder Node -file DiagphiMTotal/sectiondisp$secTag$axialLoad.tot.pos.out -closeOnWrite -time -node 2 -dof 3 disp
		recorder Node -file DiagphiMTotal/sectionreac$secTag$axialLoad.tot.pos.out -closeOnWrite -time -node 1 -dof 3 reaction
	...
	proc MomentCurvatureCompneg {secTag axialLoad maxK {numIncr 100} } {
		...
		# Create recorder
		recorder Node -file DiagphiMTotal/sectiondisp$secTag$axialLoad.tot.neg.out -closeOnWrite -time -node 2 -dof 3 disp
		recorder Node -file DiagphiMTotal/sectionreac$secTag$axialLoad.tot.neg.out -closeOnWrite -time -node 1 -dof 3 reaction
