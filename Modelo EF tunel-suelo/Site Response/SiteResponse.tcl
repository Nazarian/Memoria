...
#                                                         #
###########################################################
# Adaptado por Francisco Nazar para la Grava de Santiago. 
...
set layerThick(1)   $espesorprofundo
...
recorder Node -file Gdisplacement.out -closeOnWrite -time  -nodeRange 1 $numTotalNode -dof 1 2  disp
recorder Node -file Gvelocity.out    -closeOnWrite -time  -nodeRange 1 $numTotalNode -dof 1 2  vel
recorder Node -file Gacceleration.out -closeOnWrite -time  -nodeRange 1 $numTotalNode -dof 1 2  accel

# record stress and strain at each gauss point in the soil elements
recorder Element -file Gstress1.out -closeOnWrite  -time  -eleRange  1   $numTotalEle   material 1 stress
recorder Element -file Gstress2.out -closeOnWrite  -time  -eleRange  1   $numTotalEle   material 2 stress
recorder Element -file Gstress3.out -closeOnWrite -time  -eleRange  1   $numTotalEle   material 3 stress
recorder Element -file Gstress4.out -closeOnWrite -time  -eleRange  1   $numTotalEle   material 4 stress

recorder Element -file Gstrain1.out -closeOnWrite -time  -eleRange  1   $numTotalEle   material 1 strain
recorder Element -file Gstrain2.out -closeOnWrite -time  -eleRange  1   $numTotalEle   material 2 strain
recorder Element -file Gstrain3.out -closeOnWrite -time  -eleRange  1   $numTotalEle   material 3 strain
recorder Element -file Gstrain4.out -closeOnWrite -time  -eleRange  1   $numTotalEle   material 4 strain
...
set velocityFile velocityHistoryStgocentroSuelo.txt1.out
